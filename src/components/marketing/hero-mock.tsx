...
export function HeroMock() {
  return (
    <div className="w-full min-w-0 overflow-hidden" aria-hidden="true">
      <div className="overflow-hidden rounded-[22px] border border-[var(--border)] bg-[var(--card)] shadow-[inset_0_1px_0_rgba(255,255,255,0.9)]">
        <div className="flex items-center gap-2 border-b border-[var(--border)] bg-[var(--neu-bg-pop)] px-3 py-2.5">
          ...
          <div className="ml-1 min-w-0 flex-1 truncate rounded-md bg-[var(--address-bar-bg)] px-2.5 py-1 text-[10px] font-medium text-[var(--text-3)] sm:text-[11px]">
        ...
        <div className="relative bg-[linear-gradient(180deg,#f8fbff_0%,#eef4fb_100%)] p-3 sm:p-4">
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--card)] p-3 shadow-sm sm:p-4">
