...
export default function DemonstrationPage() {
  return (
    <main className="min-h-screen overflow-x-clip bg-[var(--neu-bg)] text-[var(--text)]">
      <ScrollMotion />
      <header className="border-b border-[var(--border)] bg-[var(--header-bg)] backdrop-blur">
