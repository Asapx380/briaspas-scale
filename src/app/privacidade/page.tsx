  ...
  return (
    <main className="min-h-screen bg-[var(--neu-bg)] px-5 py-12 text-[var(--text)] sm:px-8 sm:py-16">
      ...
      <article className="mx-auto max-w-3xl">
        <div className="landing-enter flex items-center justify-between gap-4">
          <Link href="/" className="marketing-link marketing-eyebrow inline-flex items-center gap-2 text-sm font-semibold">
            <ArrowLeft size={16} weight="bold" className="marketing-arrow" /> Voltar
          </Link>
          <ThemeToggle />
        </div>

        <header data-reveal className="mt-10 border-b border-[var(--border)] pb-10">
        ...
        <section data-reveal className="mt-10 rounded-[24px] bg-[var(--card)] p-7 shadow-[var(--shadow-card)] sm:p-9">
        ...
        <section data-reveal className="reveal-delay-1 mt-5 rounded-[24px] bg-[var(--card)] p-7 shadow-[var(--shadow-card)] sm:p-9">
